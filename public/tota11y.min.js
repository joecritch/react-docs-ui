...
!(function(e) {
        ...
        return r(n, [
          {
            ...
            value: function(e) {
              e === this.activePlugin
                ...
                : (this.activePlugin &&
                    this.activePlugin.deactivate(), e.activate(), (this.activePlugin = e));
            },
          },
          {
            key: 'appendTo',
            value: function(t) {
              ...
              var c = e('div', { className: 'tota11y-plugins' }, l, u),
                p = function(e) {
                  e.preventDefault(), e.stopPropagation(), s.toggleClass(
                    'tota11y-expanded'
  ...
  function(e, t, n) {
    ...
    !(function(t, n) {
      ...
      function c() {
        te.removeEventListener(
          ...
          c,
          !1
        ), n.removeEventListener('load', c, !1), re.ready();
      }
      function p() {
      ...
      function d(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
          if (
            ((r =
              'data-' +
              t.replace(Ce, '-$1').toLowerCase()), (n = e.getAttribute(
              r
            )), 'string' == typeof n)
          ) {
            try {
              n = 'true' === n
                ...
                : 'false' === n
                    ...
                    : 'null' === n
                        ? null
                        : +n + '' === n ? +n : Ee.test(n) ? re.parseJSON(n) : n;
            } catch (a) {}
            Ae.set(e, t, n);
          } else n = void 0;
        return n;
      ...
      function x(e, t) {
        ...
        if (1 === t.nodeType) {
          if (
            we.hasData(e) &&
            ((o = we.access(e)), (i = we.set(t, o)), (u = o.events))
          ) {
          ...
          Ae.hasData(e) &&
            ((s = Ae.access(e)), (l = re.extend({}, s)), Ae.set(t, l));
        }
      }
      function w(e, t) {
      ...
      function E(e, t) {
        var r,
          ...
          o = n.getDefaultComputedStyle && (r = n.getDefaultComputedStyle(a[0]))
            ? r.display
            : re.css(a[0], 'display');
        return a.detach(), o;
      }
      function C(e) {
        ...
        return n ||
          ((n = E(e, t)), ('none' !== n && n) ||
            ((We = (We || re("<iframe frameborder='0' width='0' height='0'/>"))
              .appendTo(t.documentElement)), (t =
              We[0].contentDocument), t.write(), t.close(), (n = E(
              e,
              t
            )), We.detach()), (Ve[e] = n)), n;
      }
      function _(e, t, n) {
        ...
        return (n =
          ...
          $e(
            e
          )), n && (i = n.getPropertyValue(t) || n[t]), n && ('' !== i || re.contains(e.ownerDocument, e) || (i = re.style(e, t)), Ye.test(i) && Ge.test(t) && ((r = s.width), (a = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = i), (i = n.width), (s.width = r), (s.minWidth = a), (s.maxWidth = o))), void 0 !== i ? i + '' : i;
      }
      function T(e, t) {
        return {
          get: function() {
      ...
      function R(e, t) {
        if (t in e) return t;
        for (
          var n = t[0].toUpperCase() + t.slice(1), r = t, a = Qe.length;
          a--;
      ...
      function N(e, t, n) {
        ...
        if (0 >= a || null == a) {
          if (
            ((a = _(e, t, o)), (0 > a || null == a) &&
              (a = e.style[t]), Ye.test(a))
          )
            return a;
          (r = i && (ee.boxSizingReliable() || a === e.style[t])), (a =
            parseFloat(a) || 0);
        }
      ...
      function D(e, t, n) {
        for (
          var r, a = (it[t] || []).concat(it['*']), o = 0, i = a.length;
          i > o;
          o++
      ...
      function M(e, t, n) {
        var r,
          ...
          g = we.get(e, 'fxshow');
        n.queue ||
          ((s = re._queueHooks(e, 'fx')), null == s.unqueued &&
          ...
          ((n.overflow = [f.overflow, f.overflowX, f.overflowY]), (u = re.css(
            e,
            'display'
          )), (c = 'none' === u
            ? we.get(e, 'olddisplay') || C(e.nodeName)
            : u), 'inline' === c &&
            'none' === re.css(e, 'float') &&
            (f.display = 'inline-block')), n.overflow &&
          ((f.overflow = 'hidden'), p.always(function() {
            (f.overflow =
              n.overflow[
                0
              ]), (f.overflowX = n.overflow[1]), (f.overflowY = n.overflow[2]);
          }));
        for (r in t) if (((a = t[r]), nt.exec(a))) {
            if (
              (delete t[r], (o = o || 'toggle' === a), a ===
                (h ? 'hide' : 'show'))
            ) {
        ...
        if (re.isEmptyObject(d))
          ...
          g
            ...
            : (g = we.access(e, 'fxshow', {})), o && (g.hidden = !h), h
            ? re(e).show()
            : p.done(function() {
                re(e).hide();
              }), p.done(function() {
          ...
          for (r in d)
            (i = D(h ? g[r] : 0, r, p)), r in g ||
              ((g[r] = i.start), h &&
                ((i.end = i.start), (i.start = 'width' === r || 'height' === r
                  ? 1
                  : 0)));
        }
      }
      function j(e, t) {
        var n, r, a, o, i;
        for (n in e) if (
            ((r = re.camelCase(n)), (a = t[r]), (o = e[n]), re.isArray(o) &&
              ((a = o[1]), (o = e[n] = o[0])), n !== r &&
              ((e[r] = o), delete e[n]), (i = re.cssHooks[r]), i &&
              'expand' in i)
          ) {
      ...
      function H(e, t, n) {
        ...
        return re.map(
          ...
          D,
          u
        ), re.isFunction(u.opts.start) && u.opts.start.call(e, u), re.fx.timer(re.extend(l, { elem: e, anim: u, queue: u.opts.queue })), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always);
      }
      function q(e) {
        return function(t, n) {
          'string' != typeof t && ((n = t), (t = '*'));
          var r, a = 0, o = t.toLowerCase().match(be) || [];
          if (re.isFunction(n))
            for (; (r = o[a++]); )
              '+' === r[0]
      ...
      (re.fn = re.prototype = {
        ...
        for (
          ...
          if (null != (e = arguments[s]))
            for (t in e)
              (n = i[t]), (r = e[t]), i !== r &&
                (u && r && (re.isPlainObject(r) || (a = re.isArray(r)))
                  ? (a
                      ? ((a = !1), (o = n && re.isArray(n) ? n : []))
                      : (o = n && re.isPlainObject(n) ? n : {}), (i[
                      t
                    ] = re.extend(u, o, r)))
                  : void 0 !== r && (i[t] = r));
        return i;
        ...
        isPlainObject: function(e) {
          return 'object' !== re.type(e) || e.nodeType || re.isWindow(e)
            ? !1
            : e.constructor && !Q.call(e.constructor.prototype, 'isPrototypeOf')
                ? !1
                : !0;
        },
        ...
        each: function(e, t, n) {
          ...
          if (n) {
            if (s) for (; o > a && ((r = t.apply(e[a], n)), r !== !1); a++);
            else for (a in e) if (((r = t.apply(e[a], n)), r === !1)) break;
          } else if (s)
        ...
        makeArray: function(e, t) {
          ...
          return null != e &&
            (i(Object(e))
              ? re.merge(n, 'string' == typeof e ? [e] : e)
              : X.call(n, e)), n;
        },
        ...
        map: function(e, t, n) {
          ...
          if (s) for (; o > a; a++) (r = t(e[a], a, n)), null != r && l.push(r);
          else for (a in e) (r = t(e[a], a, n)), null != r && l.push(r);
          return z.apply([], l);
        },
        guid: 1,
        proxy: function(e, t) {
          ...
          return 'string' == typeof t &&
            ((n = e[t]), (t = e), (e = n)), re.isFunction(e)
            ? ((r = $.call(arguments, 2)), (a = function() {
                return e.apply(t || this, r.concat($.call(arguments)));
              }), (a.guid = e.guid = e.guid || re.guid++), a)
            : void 0;
        },
        now: Date.now,
        support: ee,
	 ...
	 */ = (function(
        ...
        function t(e, t, n, r) {
          ...
          if (
            ((t ? t.ownerDocument || t : F) !== I && O(t), (t =
              t || I), (n = n || []), (s = t.nodeType), 'string' != typeof e ||
              !e ||
              (1 !== s && 9 !== s && 11 !== s))
          )
            return n;
          if (!r && P) {
            if (11 !== s && (a = ve.exec(e)))
              if ((i = a[1])) {
                if (9 === s) {
                  if (((o = t.getElementById(i)), !o || !o.parentNode))
                    return n;
                ...
                if ((i = a[3]) && w.getElementsByClassName)
                  return Z.apply(n, t.getElementsByClassName(i)), n;
              }
            if (w.qsa && (!D || !D.test(e))) {
              if (
                ((f = p = q), (h = t), (g = 1 !== s && e), 1 === s &&
                  'object' !== t.nodeName.toLowerCase())
              ) {
                for (
                  (u = _(e)), (p = t.getAttribute('id'))
                    ? (f = p.replace(xe, '\\$&'))
                    : t.setAttribute('id', f), (f = "[id='" + f + "'] "), (l =
                    u.length);
                  l--;
        ...
        function n() {
          function e(n, r) {
            return t.push(n + ' ') > A.cacheLength && delete e[t.shift()], (e[
              n + ' '
            ] = r);
          }
          var t = [];
        ...
        function u(e) {
          return r(function(t) {
            return (t = +t), r(function(n, r) {
              for (
                var a, o = e([], n.length, t), i = o.length;
                i--;
        ...
        function b(e, t, n, a, o, i) {
          return a && !a[q] && (a = b(a)), o &&
            !o[q] &&
            (o = b(o, i)), r(function(r, i, s, l) {
            var u,
              c,
              p,
              d = [],
        ...
        try {
          Z.apply((X = Q.call(F.childNodes)), F.childNodes), X[
            F.childNodes.length
          ].nodeType;
        } catch (Ce) {
          Z = {
        ...
        (w = t.support = {}), (C = t.isXML = function(e) {
          ...
          return r !== I && 9 === r.nodeType && r.documentElement
            ? ((I = r), (L = r.documentElement), (n = r.defaultView), n &&
                n !== n.top &&
                (n.addEventListener
                  ? n.addEventListener('unload', Ee, !1)
                  : n.attachEvent && n.attachEvent('onunload', Ee)), (P = !C(
                r
                ...
                return (L.appendChild(
                  e
                ).id = q), !r.getElementsByName || !r.getElementsByName(q).length;
              })), w.getById
                ...
                }), (M = []), (D = []), (w.qsa = be.test(r.querySelectorAll)) &&
                (a(function(e) {
                  (L.appendChild(e).innerHTML =
                    ...
                    "'></a><select id='" +
                    q +
                    "-\f]' msallowcapture=''><option selected=''></option></select>"), e.querySelectorAll("[msallowcapture^='']").length && D.push('[*^$]=' + ne + '*(?:\'\'|"")'), e.querySelectorAll('[selected]').length || D.push('\\[' + ne + '*(?:value|' + te + ')'), e.querySelectorAll('[id~=' + q + '-]').length || D.push('~='), e.querySelectorAll(':checked').length || D.push(':checked'), e.querySelectorAll('a#' + q + '+*').length || D.push('.#.+[+~]');
                }), a(function(e) {
                  var t = r.createElement('input');
                  t.setAttribute(
                    'type',
                    'hidden'
                  ), e.appendChild(t).setAttribute('name', 'D'), e.querySelectorAll('[name=d]').length && D.push('name' + ne + '*[*^$|!~]?='), e.querySelectorAll(':enabled').length || D.push(':enabled', ':disabled'), e.querySelectorAll('*,:x'), D.push(',.*:');
                ...
                a(function(e) {
                  (w.disconnectedMatch = j.call(
                    e,
                    'div'
                  )), j.call(e, "[s!='']:x"), M.push('!=', ie);
                }), (D = D.length && new RegExp(D.join('|'))), (M =
                M.length && new RegExp(M.join('|'))), (t = be.test(
                L.compareDocumentPosition
              )), (H = t || be.test(L.contains)
                ? function(e, t) {
          ...
          if (
            ((e.ownerDocument || e) !== I && O(e), (n = n.replace(
              pe,
              "='$1']"
            )), w.matchesSelector &&
              P &&
          ...
          var n = A.attrHandle[t.toLowerCase()],
            r = n && z.call(A.attrHandle, t.toLowerCase())
              ? n(e, t, !P)
              : void 0;
          return void 0 !== r
            ? r
          ...
          var t, n = [], r = 0, a = 0;
          if (
            ((N = !w.detectDuplicates), (S =
              !w.sortStable && e.slice(0)), e.sort(Y), N)
          ) {
            for (; (t = e[a++]); )
              t === e[a] && (r = n.push(a));
            for (; r--; )
          ...
          preFilter: {
            ATTR: function(e) {
              return (e[1] = e[1].replace(we, Ae)), (e[3] = (e[3] ||
                e[4] ||
                e[5] ||
                '')
                .replace(we, Ae)), '~=' === e[2] &&
          ...
          filter: {
            ...
            PSEUDO: function(e, n) {
              ...
              return o[q]
                ? o(n)
                : o.length > 1
                    ? ((a = [e, e, '', n]), A.setFilters.hasOwnProperty(
                        e.toLowerCase()
                      )
                        ? r(function(e, t) {
                            for (
                              var r, a = o(e, n), i = a.length;
                              i--;
          ...
          pseudos: {
            ...
            lang: r(function(e) {
              return fe.test(e || '') ||
                t.error(
                  'unsupported lang: ' + e
                ), (e = e.replace(we, Ae).toLowerCase()), function(t) {
                var n;
                do if (
                    (n = P
                      ? t.lang
        ...
        for (x in { submit: !0, reset: !0 })
          A.pseudos[x] = l(x);
        return (p.prototype = A.filters =
          A.pseudos), (A.setFilters = new p()), (_ = t.tokenize = function(
          e,
          n
        ) {
          ...
          for ((s = e), (l = []), (u = A.preFilter); s; ) {
            (!r || (a = ue.exec(s))) &&
              (a && (s = s.slice(a[0].length) || s), l.push(
                (o = [])
              )), (r = !1), (a = ce.exec(s)) &&
              ((r = a.shift()), o.push({
                value: r,
          ...
          if (((n = n || []), 1 === p.length)) {
            if (
              ...
              if (
                ((t = (A.find.ID(i.matches[0].replace(we, Ae), t) || [])[
                  0
                ]), !t)
              )
                return n;
            ...
            for (
              a = he.needsContext.test(e) ? 0 : o.length;
          ...
          return (u || T(e, p))(
            ...
            !P,
            n,
            (ye.test(e) && c(t.parentNode)) || t
          ), n;
        }), (w.sortStable =
          q.split('').sort(Y).join('') ===
          q), (w.detectDuplicates = !!N), O(), (w.sortDetached = a(function(e) {
      ...
      (re.filter = function(e, t, n) {
        ...
        find: function(e) {
          ...
          if ('string' != typeof e)
            return this.pushStack(
              re(e).filter(function() {
                for (t = 0; n > t; t++) if (re.contains(a[t], this)) return !0;
              })
            );
          for (t = 0; n > t; t++)
            re.find(e, a[t], r);
          return (r = this.pushStack(
            n > 1 ? re.unique(r) : r
          )), (r.selector = this.selector ? this.selector + ' ' + e : e), r;
        },
        filter: function(e) {
        ...
        is: function(e) {
          return !!s(
            this,
            'string' == typeof e && ue.test(e) ? re(e) : e || [],
            !1
          ).length;
        },
      });
      var de,
        ...
        he = (re.fn.init = function(e, t) {
          ...
          if ('string' == typeof e) {
            ...
            if (n[1]) {
              if (
                ((t = t instanceof re ? t[0] : t), re.merge(
                  this,
                  re.parseHTML(
                    n[1],
            ...
            return (r = te.getElementById(n[2])), r &&
              r.parentNode &&
              ((this.length = 1), (this[
                0
              ] = r)), (this.context = te), (this.selector = e), this;
          }
          return e.nodeType
            ? ((this.context = this[0] = e), (this.length = 1), this)
            : re.isFunction(e)
                ? 'undefined' != typeof de.ready ? de.ready(e) : e(re)
                : (void 0 !== e.selector &&
                    ((this.selector = e.selector), (this.context =
                      e.context)), re.makeArray(e, this));
        });
        ...
        function(e, t) {
          re.fn[e] = function(n, r) {
            ...
            return 'Until' !== e.slice(-5) && (r = n), r &&
              'string' == typeof r &&
              (a = re.filter(r, a)), this.length > 1 &&
              (me[e] || re.unique(a), ge.test(e) &&
                a.reverse()), this.pushStack(a);
          };
        }
      );
      var be = /\S+/g, ve = {};
      (re.Callbacks = function(e) {
        ...
        var t,
          ...
          c = function(u) {
            ...
            (r = !1), s &&
              (l ? l.length && c(l.shift()) : t ? (s = []) : p.disable());
          },
          p = {
            add: function() {
              if (s) {
      ...
      (re.fn.ready = function(e) {
        ...
        ready: function(e) {
          (e === !0 ? --re.readyWait : re.isReady) ||
            ((re.isReady = !0), (e !== !0 && --re.readyWait > 0) ||
              (ye.resolveWith(te, [re]), re.fn.triggerHandler &&
                (re(te).triggerHandler('ready'), re(te).off('ready'))));
        },
      }), (re.ready.promise = function(e) {
        return ye ||
          ((ye = re.Deferred()), 'complete' === te.readyState
            ? setTimeout(re.ready)
            : (te.addEventListener(
                'DOMContentLoaded',
                c,
                !1
              ), n.addEventListener('load', c, !1))), ye.promise(e);
      }), re.ready.promise();
      ...
      (re.acceptData = function(e) {
        ...
        set: function(e, t, n) {
          var r, a = this.key(e), o = this.cache[a];
        ...
        access: function(e, t, n) {
          ...
          return void 0 === t || (t && 'string' == typeof t && void 0 === n)
            ? ((r = this.get(e, t)), void 0 !== r
                ? r
                : this.get(e, re.camelCase(t)))
            : (this.set(e, t, n), void 0 !== n ? n : t);
        },
        remove: function(e, t) {
          var n, r, a, o = this.key(e), i = this.cache[o];
          if (void 0 === t) this.cache[o] = {};
          else {
            re.isArray(t)
              ? (r = t.concat(t.map(re.camelCase)))
              : ((a = re.camelCase(t)), t in i
                  ? (r = [t, a])
                  : ((r = a), (r = r in i ? [r] : r.match(be) || []))), (n =
              r.length);
            for (; n--; )
              delete i[r[n]];
          }
      ...
      re.extend({
        ...
        data: function(e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((a = Ae.get(o)), 1 === o.nodeType && !we.get(o, 'hasDataAttrs'))
            ) {
              for (n = i.length; n--; )
                i[n] &&
                  ((r = i[n].name), 0 === r.indexOf('data-') &&
                    ((r = re.camelCase(r.slice(5))), d(o, r, a[r])));
                  ...
                  if (o && void 0 === t) {
                    ...
                    this.each(function() {
                      ...
                      Ae.set(
                        ...
                        r,
                        t
                      ), -1 !== e.indexOf('-') && void 0 !== n && Ae.set(this, e, t);
                    });
                },
                null,
                t,
        ...
        queue: function(e, t, n) {
          var r;
          return e
            ? ((t = (t || 'fx') + 'queue'), (r = we.get(e, t)), n &&
                (!r || re.isArray(n)
                  ? (r = we.access(e, t, re.makeArray(n)))
                  : r.push(n)), r || [])
            : void 0;
        },
        dequeue: function(e, t) {
          ...
          'inprogress' === a && ((a = n.shift()), r--), a &&
            ('fx' === t && n.unshift('inprogress'), delete o.stop, a.call(
              e,
              i,
              o
            )), !r && o && o.empty.fire();
      ...
      var _e = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        Re = function(e, t) {
          return (e = t || e), 'none' === re.css(e, 'display') ||
      ...
      !(function() {
        ...
        n.setAttribute(
          'type',
          'radio'
        ), n.setAttribute('checked', 'checked'), n.setAttribute('name', 't'), t.appendChild(n), (ee.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked), (t.innerHTML = '<textarea>x</textarea>'), (ee.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue);
      })();
      var Se = 'undefined';
      ...
      (re.event = {
        ...
        add: function(e, t, n, r, a) {
          ...
          if (m)
            for (
              n.handler &&
                ((o = n), (n = o.handler), (a = o.selector)), n.guid ||
                (n.guid = re.guid++), (l = m.events) ||
                (l = m.events = {}), (i = m.handle) ||
                (i = m.handle = function(t) {
                  return typeof re !== Se && re.event.triggered !== t.type
                    ? re.event.dispatch.apply(e, arguments)
                    : void 0;
                }), (t = (t || '').match(be) || ['']), (u = t.length);
              u--;

            )
              (s = Le.exec(t[u]) || []), (f = g = s[1]), (h = (s[2] || '')
                .split('.')
                .sort()), f &&
                ((p = re.event.special[f] || {}), (f =
                  (a ? p.delegateType : p.bindType) || f), (p = re.event
                  .special[f] || {}), (c = re.extend(
                  {
                    type: f,
                    origType: g,
                    data: r,
                  ...
                  ((d = l[f] = []), (d.delegateCount = 0), (p.setup &&
                    p.setup.call(e, r, h, i) !== !1) ||
                    (e.addEventListener &&
                      e.addEventListener(f, i, !1))), p.add &&
                  (p.add.call(e, c), c.handler.guid ||
                    (c.handler.guid = n.guid)), a
                  ? d.splice(d.delegateCount++, 0, c)
                  : d.push(c), (re.event.global[f] = !0));
        },
          ...
          if (m && (l = m.events)) {
            for ((t = (t || '').match(be) || ['']), (u = t.length); u--; )
              if (
                ...
                for (
                  (p = re.event.special[f] || {}), (f =
                    (r ? p.delegateType : p.bindType) || f), (d = l[f] || [
                  ]), (s =
                    s[2] &&
                    new RegExp(
                      '(^|\\.)' + h.join('\\.(?:.*\\.|)') + '(\\.|$)'
                  ...
                  (c = d[o]), (!a && g !== c.origType) ||
                    (n && n.guid !== c.guid) ||
                    (s && !s.test(c.namespace)) ||
                    (r && r !== c.selector && ('**' !== r || !c.selector)) ||
                    (d.splice(o, 1), c.selector &&
                      d.delegateCount--, p.remove && p.remove.call(e, c));
                i &&
                  !d.length &&
                  ((p.teardown && p.teardown.call(e, h, m.handle) !== !1) ||
                    re.removeEvent(e, f, m.handle), delete l[f]);
              } else for (f in l) re.event.remove(e, f + t[u], n, r, !0);
        ...
        trigger: function(e, t, r, a) {
          ...
          if (
            ((i = s = r = r || te), 3 !== r.nodeType &&
              8 !== r.nodeType &&
              !Ie.test(f + re.event.triggered) &&
              (f.indexOf('.') >= 0 &&
                ((h = f.split('.')), (f = h.shift()), h.sort()), (u =
                f.indexOf(':') < 0 && 'on' + f), (e = e[re.expando]
                ? e
                : new re.Event(f, 'object' == typeof e && e)), (e.isTrigger = a
                ? 2
                : 3), (e.namespace = h.join('.')), (e.namespace_re = e.namespace
                ? new RegExp('(^|\\.)' + h.join('\\.(?:.*\\.|)') + '(\\.|$)')
                : null), (e.result = void 0), e.target ||
                (e.target = r), (t = null == t
                ? [e]
                : re.makeArray(t, [e])), (p = re.event.special[f] || {}), a ||
                !p.trigger ||
                p.trigger.apply(r, t) !== !1))
          ) {
            if (!a && !p.noBubble && !re.isWindow(r)) {
              for (
                (l = p.delegateType || f), Ie.test(l + f) || (i = i.parentNode);
                i;
                i = i.parentNode
              )
                d.push(i), (s = i);
            ...
            for (o = 0; (i = d[o++]) && !e.isPropagationStopped(); )
              (e.type = o > 1 ? l : p.bindType || f), (c =
                (we.get(i, 'events') || {})[e.type] &&
                we.get(i, 'handle')), c && c.apply(i, t), (c = u && i[u]), c &&
                c.apply &&
                re.acceptData(i) &&
                ((e.result = c.apply(i, t)), e.result === !1 &&
                  e.preventDefault());
            return (e.type = f), a ||
              ...
              (u &&
                re.isFunction(r[f]) &&
                !re.isWindow(r) &&
                ((s = r[u]), s && (r[u] = null), (re.event.triggered = f), r[
                  f
                ](), (re.event.triggered = void 0), s && (r[u] = s))), e.result;
          }
        },
        dispatch: function(e) {
          e = re.event.fix(e);
          ...
          if (
            ((s[0] = e), (e.delegateTarget = this), !u.preDispatch ||
            ...
            for (
              ...
              for (
                ...
                (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
                  ((e.handleObj = o), (e.data = o.data), (r = ((re.event
                    .special[o.origType] || {}).handle || o.handler)
                    .apply(a.elem, s)), void 0 !== r &&
                    (e.result = r) === !1 &&
          ...
          if (s && l.nodeType && (!e.button || 'click' !== e.type))
            for (; l !== this; l = l.parentNode || this)
              if (l.disabled !== !0 || 'click' !== e.type) {
                for ((r = []), (n = 0); s > n; n++)
                  (o = t[n]), (a = o.selector + ' '), void 0 === r[a] &&
                    (r[a] = o.needsContext
                      ? re(a, this).index(l) >= 0
                      : re.find(a, this, null, [l]).length), r[a] && r.push(o);
                r.length && i.push({ elem: l, handlers: r });
              }
          return s < t.length &&
            i.push({ elem: this, handlers: t.slice(s) }), i;
        },
        ...
        mouseHooks: {
          ...
          filter: function(e, t) {
            ...
            return null == e.pageX &&
              null != t.clientX &&
              ((n = e.target.ownerDocument || te), (r = n.documentElement), (a =
                n.body), (e.pageX =
                t.clientX +
                ((r && r.scrollLeft) || (a && a.scrollLeft) || 0) -
                ((r && r.clientLeft) || (a && a.clientLeft) || 0)), (e.pageY =
                t.clientY +
                ((r && r.scrollTop) || (a && a.scrollTop) || 0) -
                ((r && r.clientTop) || (a && a.clientTop) || 0))), e.which ||
              void 0 === o ||
        ...
        fix: function(e) {
          ...
          for (
            i ||
              (this.fixHooks[a] = i = Oe.test(a)
                ? this.mouseHooks
                : Ne.test(a) ? this.keyHooks : {}), (r = i.props
              ? this.props.concat(i.props)
              : this.props), (e = new re.Event(o)), (t = r.length);
            t--;

          )
            (n = r[t]), (e[n] = o[n]);
          return e.target || (e.target = te), 3 === e.target.nodeType &&
            (e.target = e.target.parentNode), i.filter ? i.filter(e, o) : e;
        },
        special: {
          load: { noBubble: !0 },
          focus: {
        ...
        simulate: function(e, t, n, r) {
          ...
          r
            ? re.event.trigger(a, null, t)
            : re.event.dispatch.call(t, a), a.isDefaultPrevented() &&
            n.preventDefault();
        },
        ...
        return this instanceof re.Event
          ? (e && e.type
              ...
              (e && e.timeStamp) || re.now()), void (this[re.expando] = !0))
          : new re.Event(e, t);
      }), (re.Event.prototype = {
        ...
        preventDefault: function() {
          ...
          (this.isDefaultPrevented = f), e &&
            e.preventDefault &&
            e.preventDefault();
        },
        stopPropagation: function() {
          var e = this.originalEvent;
          (this.isPropagationStopped = f), e &&
            e.stopPropagation &&
            e.stopPropagation();
        },
        stopImmediatePropagation: function() {
          var e = this.originalEvent;
          (this.isImmediatePropagationStopped = f), e &&
        ...
        re.each({ focus: 'focusin', blur: 'focusout' }, function(e, t) {
          ...
          re.event.special[t] = {
            setup: function() {
              var r = this.ownerDocument || this, a = we.access(r, t);
              a || r.addEventListener(e, n, !0), we.access(r, t, (a || 0) + 1);
            },
            teardown: function() {
              var r = this.ownerDocument || this, a = we.access(r, t) - 1;
              a
                ? we.access(r, t, a)
        ...
        on: function(e, t, n, r, a) {
          ...
          return 1 === a &&
            ((o = r), (r = function(e) {
              ...
              o.guid || (o.guid = re.guid++))), this.each(function() {
        ...
        off: function(e, t, n) {
          ...
          if (e && e.preventDefault && e.handleObj)
            return (r = e.handleObj), re(e.delegateTarget).off(
      ...
      (Ue.optgroup =
        Ue.option), (Ue.tbody = Ue.tfoot = Ue.colgroup = Ue.caption = Ue.thead), (Ue.th = Ue.td), re.extend(
        {
          clone: function(e, t, n) {
            ...
            if (
              ...
              for ((i = w(s)), (o = w(e)), (r = 0), (a = o.length); a > r; r++)
                A(o[r], i[r]);
            if (t)
              if (n)
                for (
                  (o = o || w(e)), (i = i || w(s)), (r = 0), (a = o.length);
                  a > r;
                  r++
                )
                  x(o[r], i[r]);
              else x(e, s);
            return (i = w(s, 'script')), i.length > 0 &&
              y(i, !l && w(e, 'script')), s;
          },
              ...
              if (((a = e[d]), a || 0 === a))
                if ('object' === re.type(a)) re.merge(p, a.nodeType ? [a] : a);
                  ...
                  for (
                    (o =
                      o ||
                      c.appendChild(t.createElement('div'))), (i = (De.exec(
                      a
                    ) || ['', ''])[1]
                      .toLowerCase()), (s =
                      Ue[i] || Ue._default), (o.innerHTML =
                      s[1] + a.replace(Pe, '<$1></$2>') + s[2]), (u = s[0]);
                    u--;

                  )
                    o = o.lastChild;
                  re.merge(p, o.childNodes), (o =
                    c.firstChild), (o.textContent = '');
                } else p.push(t.createTextNode(a));
            for ((c.textContent = ''), (d = 0); (a = p[d++]); )
              if (
                (!r || -1 === re.inArray(a, r)) &&
                ((l = re.contains(a.ownerDocument, a)), (o = w(
                  c.appendChild(a),
                  'script'
                )), l && y(o), n)
              )
          ...
          cleanData: function(e) {
            for (
              var t, n, r, a, o = re.event.special, i = 0;
              void 0 !== (n = e[i]);
              i++
            ) {
              if (
                re.acceptData(n) &&
                ((a = n[we.expando]), a && (t = we.cache[a]))
              ) {
                if (t.events)
                  for (r in t.events)
                    o[r]
                      ? re.event.remove(n, r)
                      : re.removeEvent(n, r, t.handle);
        ...
        remove: function(e, t) {
          for (
            var n, r = e ? re.filter(e, this) : this, a = 0;
            null != (n = r[a]);
            a++
          )
            t || 1 !== n.nodeType || re.cleanData(w(n)), n.parentNode &&
              (t &&
                re.contains(n.ownerDocument, n) &&
                y(w(n, 'script')), n.parentNode.removeChild(n));
          return this;
        },
        empty: function() {
          ...
          return xe(
            ...
            function(e) {
              ...
              if (
                'string' == typeof e &&
                !je.test(e) &&
                !Ue[(De.exec(e) || ['', ''])[1].toLowerCase()]
              ) {
                e = e.replace(Pe, '<$1></$2>');
                try {
                  for (; r > n; n++)
                    (t = this[n] || {}), 1 === t.nodeType &&
                      (re.cleanData(w(t, !1)), (t.innerHTML = e));
                  t = 0;
                } catch (a) {}
              }
        ...
        replaceWith: function() {
          ...
          return this.domManip(arguments, function(t) {
            (e = this
              .parentNode), re.cleanData(w(this)), e && e.replaceChild(t, this);
        ...
        domManip: function(e, t) {
          ...
          if (
            f ||
            (u > 1 && 'string' == typeof d && !ee.checkClone && He.test(d))
          )
          ...
          if (
            u &&
            ((n = re.buildFragment(e, this[0].ownerDocument, !1, this)), (r =
              n.firstChild), 1 === n.childNodes.length && (n = r), r)
          ) {
            for ((a = re.map(w(n, 'script'), b)), (o = a.length); u > l; l++)
              (i = n), l !== p &&
                ((i = re.clone(i, !0, !0)), o &&
                  re.merge(a, w(i, 'script'))), t.call(this[l], i, l);
            if (o)
              for (
                (s = a[a.length - 1].ownerDocument), re.map(a, v), (l = 0);
                o > l;
                l++
              )
                (i = a[l]), qe.test(i.type || '') &&
                  !we.access(i, 'globalEval') &&
                  re.contains(s, i) &&
                  (i.src
                    ? re._evalUrl && re._evalUrl(i.src)
                    : re.globalEval(i.textContent.replace(Be, '')));
          }
          return this;
        },
      }), re.each(
        ...
        function(e, t) {
          re.fn[e] = function(e) {
            for (var n, r = [], a = re(e), o = a.length - 1, i = 0; o >= i; i++)
              (n = i === o ? this : this.clone(!0)), re(a[i])[t](n), X.apply(
                r,
                n.get()
              );
      ...
      !(function() {
        function e() {
          (i.style.cssText =
            '-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute'), (i.innerHTML = ''), a.appendChild(o);
        ...
        i.style &&
          ((i.style.backgroundClip = 'content-box'), (i.cloneNode(
            ...
            ''), (ee.clearCloneStyle =
            'content-box' === i.style.backgroundClip), (o.style.cssText =
            'border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute'), o.appendChild(
            i
          ), n.getComputedStyle &&
            re.extend(ee, {
              ...
              reliableMarginRight: function() {
                ...
                return (t.style.cssText = i.style.cssText =
                  '-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0'), (t.style.marginRight = t.style.width =
                  '0'), (i.style.width = '1px'), a.appendChild(
                  o
                ), (e = !parseFloat(
                  n.getComputedStyle(t, null).marginRight
                )), a.removeChild(o), i.removeChild(t), e;
              },
            }));
      ...
      re.extend({
        ...
        style: function(e, t, n, r) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            var a, o, i, s = re.camelCase(t), l = e.style;
            return (t = re.cssProps[s] || (re.cssProps[s] = R(l, s))), (i =
              re.cssHooks[t] || re.cssHooks[s]), void 0 === n
              ? i && 'get' in i && void 0 !== (a = i.get(e, !1, r)) ? a : l[t]
              : ((o = typeof n), 'string' === o &&
                  (a = Ke.exec(n)) &&
                  ((n = (a[1] + 1) * a[2] + parseFloat(re.css(e, t))), (o =
                    'number')), null != n &&
                  n === n &&
                  ('number' !== o ||
                    re.cssNumber[s] ||
                    (n += 'px'), ee.clearCloneStyle ||
                    '' !== n ||
        ...
        css: function(e, t, n, r) {
          ...
          return (t = re.cssProps[s] || (re.cssProps[s] = R(e.style, s))), (i =
            re.cssHooks[t] || re.cssHooks[s]), i &&
            'get' in i &&
            (a = i.get(e, !0, n)), void 0 === a &&
            (a = _(e, t, r)), 'normal' === a && t in Ze && (a = Ze[t]), '' ===
            n || n
            ? ((o = parseFloat(a)), n === !0 || re.isNumeric(o) ? o || 0 : a)
            : a;
        },
        ...
        re.cssHooks[t] = {
          ...
          set: function(e, n, r) {
            ...
            return k(
              ...
              n,
              r
                ? S(e, t, r, 'border-box' === re.css(e, 'boxSizing', !1, a), a)
                : 0
            );
          },
        };
        ...
        return t
          ? re.swap(e, { display: 'inline-block' }, _, [e, 'marginRight'])
          : void 0;
      })), re.each({ margin: '', padding: '', border: 'Width' }, function(
        e,
        t
      ) {
        (re.cssHooks[e + t] = {
          expand: function(n) {
            for (
              var r = 0, a = {}, o = 'string' == typeof n ? n.split(' ') : [n];
              4 > r;
              r++
            )
        ...
        run: function(e) {
          ...
          return this.options.duration
            ...
            ? n.set(this)
            : I.propHooks._default.set(this), this;
        },
        ...
        it = {
          '*': [
            function(e, t) {
              ...
              return a &&
                ((i = n.start = +i || +r || 0), (n.unit = o), (n.end = a[1]
                  ? i + (a[1] + 1) * a[2]
                  : +a[2])), n;
            },
          ],
      ...
      (re.Animation = re.extend(H, {
        ...
        return (r.duration = re.fx.off
          ? 0
          : 'number' == typeof r.duration
              ? r.duration
              : r.duration in re.fx.speeds
                  ? re.fx.speeds[r.duration]
                  : re.fx.speeds._default), (null == r.queue ||
          r.queue === !0) &&
          (r.queue = 'fx'), (r.old = r.complete), (r.complete = function() {
          re.isFunction(r.old) && r.old.call(this), r.queue &&
            re.dequeue(this, r.queue);
        }), r;
      }), re.fn.extend({
        ...
        stop: function(e, t, n) {
          ...
          return 'string' != typeof e && ((n = t), (t = e), (e = void 0)), t &&
            ...
            else for (a in i) i[a] && i[a].stop && at.test(a) && r(i[a]);
            for (
              a = o.length;
              a--;
        ...
        finish: function(e) {
          return e !== !1 && (e = e || 'fx'), this.each(function() {
            var t,
              ...
              i = r ? r.length : 0;
            for (
              (n.finish = !0), re.queue(this, e, []), a &&
                a.stop &&
                a.stop.call(this, !0), (t = o.length);
              t--;
      ...
      }), (re.fx.speeds = { slow: 600, fast: 200, _default: 400 }), (re.fn.delay = function(
        e,
        t
      ) {
        return (e = re.fx ? re.fx.speeds[e] || e : e), (t =
        ...
        (e.type =
          'checkbox'), (ee.checkOn = '' !== e.value), (ee.optSelected = n.selected), (t.disabled = !0), (ee.optDisabled = !n.disabled), (e = te.createElement('input')), (e.value = 't'), (e.type = 'radio'), (ee.radioValue = 't' === e.value);
      })();
      ...
      re.fn.extend({
          ...
          if (e && 3 !== o && 8 !== o && 2 !== o)
            return typeof e.getAttribute === Se
              ...
              : ((1 === o && re.isXMLDoc(e)) ||
                  ((t = t.toLowerCase()), (r =
                    re.attrHooks[t] ||
                    (re.expr.match.bool.test(t) ? lt : st))), void 0 === n
        ...
        removeAttr: function(e, t) {
          var n, r, a = 0, o = t && t.match(be);
          if (o && 1 === e.nodeType)
            for (; (n = o[a++]); )
              (r = re.propFix[n] || n), re.expr.match.bool.test(n) &&
      ...
      re.fn.extend({
        ...
        prop: function(e, t, n) {
          ...
          if (e && 3 !== i && 8 !== i && 2 !== i)
            return (o = 1 !== i || !re.isXMLDoc(e)), o &&
              ((t = re.propFix[t] || t), (a = re.propHooks[t])), void 0 !== n
              ? a && 'set' in a && void 0 !== (r = a.set(e, n, t))
                  ? r
                  : (e[t] = n)
              : a && 'get' in a && null !== (r = a.get(e, t)) ? r : e[t];
        },
        propHooks: {
          tabIndex: {
            get: function(e) {
              return e.hasAttribute('tabindex') || ct.test(e.nodeName) || e.href
                ? e.tabIndex
                : -1;
            },
          },
      ...
      re.fn.extend({
          ...
          return 'boolean' == typeof t && 'string' === n
            ...
            : re.isFunction(e)
                ...
                : this.each(function() {
                    if ('string' === n)
                      for (
                        var t, r = 0, a = re(this), o = e.match(be) || [];
                        (t = o[r++]);
        ...
        hasClass: function(e) {
          for (var t = ' ' + e + ' ', n = 0, r = this.length; r > n; n++)
            if (
              1 === this[n].nodeType &&
              (' ' + this[n].className + ' ').replace(pt, ' ').indexOf(t) >= 0
            )
              return !0;
          return !1;
        },
      ...
      re.fn.extend({
        val: function(e) {
          ...
          {
            if (arguments.length)
              return (r = re.isFunction(e)), this.each(function(n) {
                var a;
                1 === this.nodeType &&
                  ((a = r ? e.call(this, n, re(this).val()) : e), null == a
                    ? (a = '')
                    : 'number' == typeof a
                        ? (a += '')
                        : re.isArray(a) &&
                    ...
                    re.valHooks[this.nodeName.toLowerCase()]), (t &&
                    'set' in t &&
            ...
            if (a)
              return (t =
                re.valHooks[a.type] ||
                re.valHooks[a.nodeName.toLowerCase()]), t &&
                'get' in t &&
        ...
        valHooks: {
          ...
          select: {
            ...
            set: function(e, t) {
              for (
                var n, r, a = e.options, o = re.makeArray(t), i = a.length;
                i--;

              )
                (r = a[i]), (r.selected = re.inArray(r.value, o) >= 0) &&
                  (n = !0);
      ...
      re.extend({
        ...
        ajax: function(e, t) {
          function n(e, t, n, i) {
            var l, c, b, v, x, A = t;
            2 !== y &&
              ((y = 2), s && clearTimeout(s), (r = void 0), (o =
                i || ''), (w.readyState = e > 0 ? 4 : 0), (l =
                (e >= 200 && 300 > e) || 304 === e), n &&
                (v = U(p, w, n)), (v = W(p, v, w, l)), l
                ? (p.ifModified &&
                    ((x = w.getResponseHeader('Last-Modified')), x &&
                      (re.lastModified[a] = x), (x = w.getResponseHeader(
                      'etag'
                    )), x && (re.etag[a] = x)), 204 === e || 'HEAD' === p.type
                    ? (A = 'nocontent')
                    : 304 === e
                        ? (A = 'notmodified')
                        : ((A = v.state), (c = v.data), (b =
                            v.error), (l = !b)))
                : ((b = A), (e || !A) &&
                    ((A = 'error'), 0 > e &&
                      (e = 0))), (w.status = e), (w.statusText =
                (t || A) + ''), l
                ? h.resolveWith(d, [c, A, w])
                : h.rejectWith(d, [w, A, b]), w.statusCode(
                m
              ), (m = void 0), u &&
                ...
                (f.trigger('ajaxComplete', [w, p]), --re.active ||
                  re.event.trigger('ajaxStop')));
          }
          ...
          if (
            ((h.promise(w).complete = g.add), (w.success = w.done), (w.error =
              w.fail), (p.url = ((e || p.url || _t) + '')
              .replace(gt, '')
              .replace(xt, Tt[1] + '//')), (p.type =
              t.method || t.type || p.method || p.type), (p.dataTypes = re
              .trim(p.dataType || '*')
              .toLowerCase()
              .match(be) || ['']), null == p.crossDomain &&
              ((l = wt.exec(p.url.toLowerCase())), (p.crossDomain = !(!l ||
                (l[1] === Tt[1] &&
                  l[2] === Tt[2] &&
                  (l[3] || ('http:' === l[1] ? '80' : '443')) ===
                    (Tt[3] || ('http:' === Tt[1] ? '80' : '443')))))), p.data &&
              p.processData &&
              'string' != typeof p.data &&
              (p.data = re.param(p.data, p.traditional)), F(At, p, t, w), 2 ===
              y)
          )
            return w;
          (u = re.event && p.global), u &&
            0 === re.active++ &&
            re.event.trigger(
              'ajaxStart'
            ), (p.type = p.type.toUpperCase()), (p.hasContent = !yt.test(
            p.type
          )), (a = p.url), p.hasContent ||
            (p.data &&
              ((a = p.url +=
                (ht.test(a) ? '&' : '?') + p.data), delete p.data), p.cache ===
              !1 &&
              (p.url = mt.test(a)
                ? a.replace(mt, '$1_=' + ft++)
                : a + (ht.test(a) ? '&' : '?') + '_=' + ft++)), p.ifModified &&
            (re.lastModified[a] &&
              w.setRequestHeader('If-Modified-Since', re.lastModified[a]), re
              .etag[a] &&
              w.setRequestHeader('If-None-Match', re.etag[a])), ((p.data &&
            p.hasContent &&
            p.contentType !== !1) ||
            t.contentType) &&
            w.setRequestHeader(
          ...
          if (p.beforeSend && (p.beforeSend.call(d, w, p) === !1 || 2 === y))
            return w.abort();
          x = 'abort';
          for (c in { success: 1, error: 1, complete: 1 })
            w[c](p[c]);
          if ((r = F(Et, p, t, w))) {
            (w.readyState = 1), u && f.trigger('ajaxSend', [w, p]), p.async &&
              p.timeout > 0 &&
        ...
        re[t] = function(e, n, r, a) {
          return re.isFunction(n) &&
            ((a = a || r), (r = n), (n = void 0)), re.ajax({
            url: e,
            type: t,
            dataType: a,
            data: n,
        ...
        wrapAll: function(e) {
          ...
          return re.isFunction(e)
            ...
            : (this[0] &&
                ((t = re(e, this[0].ownerDocument).eq(0).clone(!0)), this[0]
                  .parentNode && t.insertBefore(this[0]), t
                  .map(function() {
                    for (
                      var e = this;
                      e.firstElementChild;
      ...
      (re.param = function(e, t) {
        var n,
          r = [],
          a = function(e, t) {
            (t = re.isFunction(t) ? t() : null == t ? '' : t), (r[r.length] =
              encodeURIComponent(e) + '=' + encodeURIComponent(t));
          };
        if (
          (void 0 === t &&
            (t = re.ajaxSettings && re.ajaxSettings.traditional), re.isArray(
            e
          ) ||
            (e.jquery && !re.isPlainObject(e)))
        )
          re.each(e, function() {
      ...
      n.attachEvent &&
        ...
        !!Dt &&
        'withCredentials' in
          Dt), (ee.ajax = Dt = !!Dt), re.ajaxTransport(function(e) {
        var t;
        return ee.cors || (Dt && !e.crossDomain)
          ? {
              send: function(n, r) {
                ...
                (t = function(e) {
                  return function() {
                    t &&
                      (delete Lt[
                        i
                      ], (t = o.onload = o.onerror = null), 'abort' === e
                        ? o.abort()
                        : 'error' === e
                            ? r(o.status, o.statusText)
                            : r(
                                Pt[o.status] || o.status,
                                o.statusText,
                ...
                }), (o.onload = t()), (o.onerror = t('error')), (t = Lt[i] = t(
                  'abort'
                ));
                try {
      ...
      re.ajaxSetup({
        ...
        return s || 'jsonp' === e.dataTypes[0]
          ? ((a = e.jsonpCallback = re.isFunction(e.jsonpCallback)
              ? e.jsonpCallback()
              : e.jsonpCallback), s
              ? (e[s] = e[s].replace(jt, '$1' + a))
              : e.jsonp !== !1 &&
                  (e.url +=
                    (ht.test(e.url) ? '&' : '?') +
                    e.jsonp +
                    '=' +
                    a), (e.converters['script json'] = function() {
              ...
              (n[
                a
              ] = o), e[a] && ((e.jsonpCallback = t.jsonpCallback), Mt.push(a)), i && re.isFunction(o) && o(i[0]), (i = o = void 0);
            }), 'script')
          : void 0;
        ...
        return r
          ? [t.createElement(r[1])]
          : ((r = re.buildFragment([e], t, a)), a &&
              a.length &&
              re(a).remove(), re.merge([], r.childNodes));
      });
      var Ht = re.fn.load;
      (re.fn.load = function(e, t, n) {
        ...
        return s >= 0 &&
          ((r = re.trim(e.slice(s))), (e = e.slice(0, s))), re.isFunction(t)
          ? ((n = t), (t = void 0))
          : t && 'object' == typeof t && (a = 'POST'), i.length > 0 &&
          re
      ...
      (re.offset = {
        setOffset: function(e, t, n) {
          var r, a, o, i, s, l, u, c = re.css(e, 'position'), p = re(e), d = {};
          'static' === c &&
            (e.style.position = 'relative'), (s = p.offset()), (o = re.css(
            e,
            'top'
          )), (l = re.css(e, 'left')), (u =
            ('absolute' === c || 'fixed' === c) &&
            (o + l).indexOf('auto') > -1), u
            ? ((r = p.position()), (i = r.top), (a = r.left))
            : ((i = parseFloat(o) || 0), (a =
                parseFloat(l) || 0)), re.isFunction(t) &&
            (t = t.call(e, n, s)), null != t.top &&
            (d.top = t.top - s.top + i), null != t.left &&
            (d.left = t.left - s.left + a), 'using' in t
            ? t.using.call(e, d)
            : p.css(d);
        },
      }), re.fn.extend({
        offset: function(e) {
          ...
          var t,
            ...
            o = r && r.ownerDocument;
          if (o)
            return (t = o.documentElement), re.contains(t, r)
              ? (typeof r.getBoundingClientRect !== Se &&
                  (a = r.getBoundingClientRect()), (n = G(o)), {
        ...
        position: function() {
          if (this[0]) {
            ...
            return 'fixed' === re.css(n, 'position')
              ? (t = n.getBoundingClientRect())
              : ((e = this.offsetParent()), (t = this.offset()), re.nodeName(
                  e[0],
                  'html'
                ) || (r = e.offset()), (r.top += re.css(
                  e[0],
                  'borderTopWidth',
                  !0
            ...
            return xe(
              ...
              function(e, a, o) {
                ...
                return void 0 === o
                  ? i ? i[t] : e[a]
                  : void (i
                      ? i.scrollTo(r ? n.pageXOffset : o, r ? o : n.pageYOffset)
                      : (e[a] = o));
              },
              e,
              a,
        ...
        re.cssHooks[t] = T(ee.pixelPosition, function(e, n) {
          return n
            ? ((n = _(e, t)), Ye.test(n) ? re(e).position()[t] + 'px' : n)
            : void 0;
        });
              ...
              function(t, n, r) {
                ...
                return re.isWindow(t)
                  ...
                  : 9 === t.nodeType
                      ...
                      : void 0 === r ? re.css(t, n, i) : re.style(t, n, r, i);
              },
              t,
              o ? r : void 0,
              o,
      ...
      var i = (function() {
        ...
        return a(e, [
          ...
          },
          {
            key: 'deactivate',
            value: function() {
              this.cleanup(), this.panel.destroy(), this.$checkbox.prop(
                'checked',
                !1
              );
            },
    ...
    function r(e, t) {
      ...
      var i,
        ...
        u = (function() {
          ...
          for (
            (i = a.length), (s = Array(i > 2 ? i - 2 : 0)), (l = 2);
            i > l;
            l++
          )
            s[l - 2] = a[l];
  ...
  function(e, t, n) {
    ...
    function s(e, t) {
      ...
      if (t.singleton) {
        var s = m++;
        (n = g || (g = o())), (r = l.bind(null, n, s, !1)), (a = l.bind(
          null,
          n,
          s,
          !0
        ...
        e.sourceMap &&
          ...
          ? ((n = i()), (r = c.bind(null, n)), (a = function() {
    ...
    function l(e, t, n, r) {
      ...
      if (e.styleSheet) e.styleSheet.cssText = b(t, a);
        ...
        i[t] && e.removeChild(i[t]), i.length
  ...
  function(e, t) {
    ...
    function n(e, t) {
      ...
      for (
        ...
        this[r[l]] = s[r[l]];
      Error.captureStackTrace && Error.captureStackTrace(this, n), a &&
        ((this.lineNumber = o), (this.column = i));
    }
    t.__esModule = !0;
    var r = [
      'description',
  ...
  function(e, t) {
    ...
    function r(e) {
      ...
      return (t.showUnsupportedRulesWarning = !1), t.ignoreSelectors(
        e,
        '.tota11y *'
      ...
      axs.AuditRule.collectMatchingElements = function(e, t, n, r) {
        ...
        if (a && 'content' == a.localName)
          ...
          for (var c = e.firstChild; null != c; )
            axs.AuditRule.collectMatchingElements(c, t, n, r), (c =
              c.nextSibling);
        }
      };
    }
  ...
  function(e, t, n) {
    ...
    function a(e) {
      e.registerHelper('helperMissing', function() {
        ...
        function n(t, n, a) {
          u &&
            ((u.key = t), (u.index = n), (u.first =
              0 === n), (u.last = !!a), p &&
              (u.contextPath =
                p +
                t)), (s += r(e[t], { data: u, blockParams: l.blockParams([e[t], t], [p + t, null]) }));
        }
        ...
        if (
          (t.data &&
            t.ids &&
            (p = l.appendContextPath(t.data.contextPath, t.ids[0]) + '.'), g(
            e
          ) && (e = e.call(this)), t.data && (u = o(t.data)), e &&
            'object' == typeof e)
        )
          if (h(e))
            for (var d = e.length; d > i; i++)
              n(i, i, i === e.length - 1);
          else {
            var f = void 0;
            for (var m in e)
      ...
      var u = (function(e) {
        ...
        return a(n, e), o(n, [
          ...
          },
          {
            key: 'run',
            value: function() {
              this.summary(' '), this.panel.render(), s(
                document
              ).on('mousemove.wand', function(e) {
                var n = document.elementFromPoint(e.clientX, e.clientY),
                  r = axs.properties.findTextAlternatives(n, {});
                s('.tota11y-outlined').removeClass(
                  'tota11y-outlined'
                ), s(n).addClass('tota11y-outlined'), r ? s('.tota11y-info-section.active').text(r) : s('.tota11y-info-section.active').html(t('i', { className: 'tota11y-nothingness' }, 'No text visible to a screen reader'));
              });
            },
          },
          {
            key: 'cleanup',
            value: function() {
              s('.tota11y-outlined').removeClass('tota11y-outlined'), s(
                document
              ).off('mousemove.wand');
            },
          },
          ...
          return a(n, e), o(n, [
            ...
            },
            {
              ...
              value: function() {
                ...
                'FAIL' === t && n.forEach(this.reportError.bind(this)), s(
                  'img[role="presentation"], img[alt=""]'
                ).each(function(e, t) {
                  u
                    .errorLabel(s(t), '', 'This image is decorative')
    ...
    var d = (function(e) {
      function t() {
        r(this, t), i(
          ...
          'constructor',
          this
        ).call(this), (this.preservedColors = []);
      }
      return a(t, e), o(t, [
        {
          key: 'getTitle',
          ...
          value: function(e, t) {
            ...
            return d.find('.preview-contrast-fix').click(function(e) {
              s(e.target).prop('checked')
                ? (s(t).css('color', l.fg), s(t).css('background-color', l.bg))
            ...
            s('*').each(function(n, r) {
              if (
                ...
                if (axs.utils.isLowContrast(l, a)) {
                  ...
                  t[p] ||
                    (u.label(s(r), l).addClass('tota11y-label-success'), (t[
                      p
                    ] = !0));
              }
            });
          ...
          return a(n, e), o(n, [
              ...
              value: function(e) {
                ...
                return e.each(function(e, a) {
                  ...
                  0 === e && 1 !== i
                    ...
                    : r &&
                        i - r > 1 &&
                        (l = p.NONCONSECUTIVE_HEADER(r, i)), (r = i);
            ...
            },
            {
              ...
              value: function() {
                ...
                if (n.length) {
                  var r = t('div', { className: 'tota11y-heading-outline' }, n);
                  this.summary(r);
                }
              },
            },
          ...
          return a(n, e), o(n, [
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return (e = e.replace(/[^a-zA-Z ]/g, '').replace(n, '')), '' !==
                  e.trim();
              },
            },
            {
        ...
        p = (function() {
          function e(t) {
            r(
              this,
              e
            ), (this.plugin = t), (this.about = null), (this.summary = null), (this.errors = [
            ]), (this.$el = null);
          }
          return a(e, [
            {
            ...
            },
            {
              ...
              value: function(e, n) {
                ...
                return this.$el
                  .find('.tota11y-info-sections')
                  .append(i), a.on('activate', function() {
                  r.$el
                    .find('.tota11y-info-tab.active')
                    .removeClass(
                      'active'
                    ), r.$el.find('.tota11y-info-section.active').removeClass('active'), a.addClass('active'), i.addClass('active');
            ...
            },
            {
              ...
              value: function() {
                ...
                this.$el
                  ...
                  }), o('body').append(this.$el), (t =
                  window.innerWidth - this.$el.width() - l), (n =
                  window.innerHeight - this.$el.height() - l);
                ...
                r
                  ...
                  if (a) {
                    ...
                    (t = u + o), (n = p + l), e.$el.css({ left: t, top: n });
                  }
              ...
              value: function() {
                ...
                this.$el = t(
                  ...
                  t(
                    ...
                    t('ul', { role: 'tablist', className: 'tota11y-info-tabs' })
                  )
                );
                var r = void 0;
                return this.about &&
                  (r = this._addTab('About', this.about)), this.summary &&
                  (r = this._addTab('Summary', this.summary)), this.$el
                  .find('.toggle-annotation')
                  .click(function(e) {
                  ...
                  !(function() {
                    ...
                    e.errors.forEach(function(r, a) {
                      ...
                      l
                        ...
                        .prepend(r.$description), t.append(l);
                      ...
                      p.click(function(e) {
                        ...
                        e.$el.removeClass(c), p.removeClass(u), d.removeClass(
                          u
                        ), n.trigger('activate');
                      ...
                      f.click(function(e) {
                        ...
                        (d.toggleClass(u), p.toggleClass(
                          u
                        )), i.toggleHighlight(r.$el, p), i.toggleHighlight(r.$el, f);
                  ...
                  })(), r && (r.trigger('activate'), (n = !0)), n &&
                  this.initAndPosition(), this.$el.focus(), this.$el;
              },
            },
            {
              key: 'destroy',
              value: function() {
                (this.about = null), (this.summary = null), (this.errors = [
                ]), this.$el &&
                  (this.$el.remove(), (this.$el = null)), i.removeAll();
              },
            },
          ]), e;
        })();
    ...
    e.exports = (r['default'] || r).template({
      ...
      main: function(e, t, n, r) {
        ...
        return (
          ...
          s(
            ((a = null != (a = t.fgColorHex || (null != e ? e.fgColorHex : e))
              ? a
              : o), typeof a === i
          ...
          '/' +
          s(
            ((a = null != (a = t.bgColorHex || (null != e ? e.bgColorHex : e))
              ? a
              : o), typeof a === i
          ...
          s(
            ((a = null !=
              (a = t.contrastRatio || (null != e ? e.contrastRatio : e))
              ? a
              : o), typeof a === i
          ...
          s(
            ((a = null !=
              (a = t.requiredRatio || (null != e ? e.requiredRatio : e))
              ? a
              : o), typeof a === i
    ...
    e.exports = (r['default'] || r).template({
      ...
      main: function(e, t, n, r) {
        ...
        return (
          ...
          s(
            ((a = null != (a = t.level || (null != e ? e.level : e))
              ? a
              : o), typeof a === i
          ...
          s(
            ((a = null != (a = t.text || (null != e ? e.text : e))
              ? a
              : o), typeof a === i
              ? a.call(e, { name: 'text', hash: {}, data: r })
              : a)
          ) +
          '</span>\n</div>\n'
        );
    ...
    e.exports = (r['default'] || r).template({
      ...
      3: function(e, t, n, r) {
        ...
        return (
          ...
          this.escapeExpression(
            ((a = null != (a = t.id || (null != e ? e.id : e))
              ? a
              : t.helperMissing), 'function' == typeof a
      ...
      5: function(e, t, n, r) {
        ...
        return (
          ...
          this.escapeExpression(
            ((a = null != (a = t.tagName || (null != e ? e.tagName : e))
              ? a
              : t.helperMissing), 'function' == typeof a
    ...
    e.exports = (r['default'] || r).template({
      ...
      main: function(e, t, n, r) {
        ...
        return (
          ...
          (null !=
            ((o = null != (o = t.text || (null != e ? e.text : e))
              ? o
              : i), (a = typeof o === s
          ...
          (null !=
            ((o = null != (o = t.detail || (null != e ? e.detail : e))
              ? o
              : i), (a = typeof o === s
    ...
    e.exports = (r['default'] || r).template({
      ...
      main: function(e, t, n, r) {
        ...
        return (
          ...
          (null !=
            ((o = null != (o = t.title || (null != e ? e.title : e))
              ? o
              : t.helperMissing), (a = 'function' == typeof o
  ...
  function(e, t, n) {
    ...
    function r() {
      ...
      return d.extend(e, i), (e.SafeString = l['default']), (e.Exception =
        c['default']), (e.Utils = d), (e.escapeExpression =
        d.escapeExpression), (e.VM = h), (e.template = function(t) {
    ...
    var o = n(12),
      ...
      m = a(g),
      b = r();
    (b.create = r), m['default'](b), (b['default'] = b), (t[
      'default'
  ...
  function(e, t, n) {
    ...
    function a(e, t) {
      function n(n, r, a) {
        a.hash && (r = d.extend({}, r, a.hash)), (n = t.VM.resolvePartial.call(
          this,
          n,
          r,
          a
      ...
      function r(t) {
        ...
        return e.useDepths &&
          (i = n.depths ? [t].concat(n.depths) : [t]), e.main.call(
          a,
          t,
          a.helpers,
          a.partials,
      ...
      var a = {
        ...
        program: function(e, t, n, r, a) {
          ...
          return t || a || r || n
            ...
            : i || (i = this.programs[e] = o(this, e, s)), i;
        },
        data: function(e, t) {
          for (; e && t--; )
            e = e._parent;
      ...
      return (r.isTop = !0), (r._setup = function(n) {
        n.partial
          ...
          : ((a.helpers = a.merge(n.helpers, t.helpers)), e.usePartial &&
    ...
    function o(e, t, n, r, a, o, i) {
      ...
      return (s.program = t), (s.depth = i ? i.length : 0), (s.blockParams =
        a || 0), s;
    }
    function i(e, t, n) {
      return e
        ? e.call || n.name || ((n.name = e), (e = n.partials[e]))
        : (e = n.partials[n.name]), e;
    }
    function s(e, t, n) {
    ...
    function u(e, t) {
      return (t && 'root' in t) ||
        ((t = t ? g.createFrame(t) : {}), (t.root = e)), t;
    }
    var c = function(e) {
      return e && e.__esModule ? e : { default: e };
    };
